...
# 打包镜像
build_image() {
    sudo docker build -t hub.freelancer.com/freelancer/$1 -f ./service/$1/Dockerfile .
    echo -e "\033[32m镜像打包完成: \033[0m hub.freelancer.com/freelancer/$1\n"
}
...
# 容器启动示例
# 启动account service
# docker run -it -e PARAMS="--registry=consul --registry_address=172.28.151.126:8500" hub.fileserver.com/filestore/account